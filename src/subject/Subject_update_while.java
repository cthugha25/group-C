...
@WebServlet(urlPatterns={"/subject/Subject_update_while"})
public class Subject_update_while extends HttpServlet {
	...
	public void doGet (
		...
		try {
			...
			String subject_cd = request.getParameter("no");

			SubjectDao dao=new SubjectDao();
			Subject subject=dao.get(subject_cd, school);
